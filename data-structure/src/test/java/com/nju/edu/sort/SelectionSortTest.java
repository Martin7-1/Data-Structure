...
public class SelectionSortTest {
    ...
    public void randomSortTest() {
        ...
        for (int i = 0; i < 5000; i++) {
            ...
            Arrays.sort(expect);
            System.out.println("my selection sort start time = " + System.currentTimeMillis());
            sort.sort();
            System.out.println("my selection sort end time = " + System.currentTimeMillis());
            System.out.println();
            actual = sort.getArr();
